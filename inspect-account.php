<?php
echo '<script>let acctID = '.$_GET['accountID'].'</script>';
?>
    ...
    <div class="root-fb">
        <div class="toolbar">
            <div class="tb-btn-group">
                ...
                <h1 class="list-header">Inspect this Account</h1>
            </div>
            <div class="tb-btn-group">
        ...
        <div class="flexbox">
            <div class="col1" id="ca">
                <div class="content-area">
                    ...
                    $accountID = htmlspecialchars(trim($_GET['accountID']), ENT_QUOTES, 'UTF-8');
                    if(isset($_GET['category'])&&isset($_GET['startDate'])&&isset($_GET['endDate'])){
                        ...
                        $total_query = "SELECT COUNT(*) as total FROM Payment WHERE accountID = ". $accountID ." AND category = "."'"."$selectedCategory"."' AND date BETWEEN "."'"."$startDate"."'"." AND "."'"."$endDate"."'";
                        $select_query = "SELECT * FROM Payment WHERE accountID = ". $accountID ." AND category = "."'"."$selectedCategory"."' AND date BETWEEN "."'"."$startDate"."'"." AND "."'"."$endDate"."'"." LIMIT $offset, $records_per_page";
                    }else if(isset($_GET['category'])){
                        $selectedCategory = $_GET['category'];
                        $total_query = "SELECT COUNT(*) as total FROM Payment WHERE accountID = ". $accountID ." AND category = "."'"."$selectedCategory"."'";
                        $select_query = "SELECT * FROM Payment WHERE accountID = ". $accountID ." AND category = "."'"."$selectedCategory"."'"." LIMIT $offset, $records_per_page";
                    }else if(isset($_GET['startDate'])&&isset($_GET['endDate'])){
                        $startDate = $_GET['startDate'];
                        $endDate = $_GET['endDate'];
                        $startDate = htmlspecialchars(trim($_GET['startDate']), ENT_QUOTES, 'UTF-8');
                        $endDate = htmlspecialchars(trim($_GET['endDate']), ENT_QUOTES, 'UTF-8');
                        $total_query = "SELECT COUNT(*) as total FROM Payment WHERE accountID = ". $accountID ." AND date BETWEEN "."'"."$startDate"."'"." AND "."'"."$endDate"."'";
                        $select_query = "SELECT * FROM Payment WHERE accountID = ". $accountID ." AND date BETWEEN "."'"."$startDate"."'"." AND "."'"."$endDate"."'"." LIMIT $offset, $records_per_page";
                    }else{
                        $total_query = "SELECT COUNT(*) as total FROM Payment WHERE accountID = ".$accountID;
                        $select_query = "SELECT * FROM Payment WHERE accountID = ".$accountID." LIMIT $offset, $records_per_page";
                    }
...
<script>
    ...
    function deAssoc(payid){
        ...
        document.getElementById('deAssocOutputArea').src = "payment-deassoc-acct.php?paymentID="+payid;
    }
    ...
    function assocNextPg(){
        ...
        document.getElementById('assocOutputArea').src = "payment-assoc-acct.php?accountID="+acctID+"&paymentID="+document.getElementById('paymentID').value;
    }
...
<dialog id="AssocDlg">
    <div id="assoc-pg1" style="display: none;flex-direction: column;">
        ...
        <select name="paymentID" id="paymentID" required>
            ...
            $result = $db->query($select_query);
            while ($row = $result->fetchArray(SQLITE3_ASSOC)) {
                if($row['accountID'] != $_GET['accountID']){
